          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{displayProspects.length}</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {displayProspects.filter(p => p.segment === 'Senior').length}
                </p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {displayProspects.length > 0 ? Math.round(displayProspects.reduce((acc, p) => acc + p.score, 0) / displayProspects.length) : 0}
                </p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  €{Math.round(displayProspects.reduce((acc, p) => acc + (p.revenue_potential || 0), 0) / 1000)}K
                </p>
              </div>
